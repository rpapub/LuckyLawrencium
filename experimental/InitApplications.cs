using LuckyLawrencium.ObjectRepository;
using System;
...
namespace LuckyLawrencium.RnD
{
    public class InitApplications : CodedWorkflow
    {
        [Workflow]
        public void Execute()
        {
            ...
            var screen = uiAutomation.Open(Descriptors.Calculator.Standard);
        }
    }
}